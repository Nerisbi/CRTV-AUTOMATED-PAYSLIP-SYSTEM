...
class CRTVPayslipApp(tb.Window):
    ...
    def __init__(self):
        ...
        self.input_pdf_path.set("input/payslip.pdf")
    ...
    def show_dashboard(self):
        ...
        tb.Button(
            ...
            command=lambda: self.preview_process,
    ...
    def show_upload(self):
        ...
        self.create_file_selector(upload_frame, "Payslip PDF:", self.input_pdf_path, "PDF files (*.pdf)", 0)
    ...
    def show_send(self):
        ...
        tb.Button(
            ...
            command=lambda: self.test_email_connection,
    ...
    def validate_files(self):
        ...
        self.service.input_pdf = self.input_pdf_path.get()
    ...
    def start_sending(self):
        ...
        result = messagebox.askyesno(
            ...
            "This will process the PDF file and send individual payslips to matching employees.\n\n"
